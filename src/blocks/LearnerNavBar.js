...
export default function LearnerNavBar({ user }) {
            ...
            <div className="navbar-start mb-0">
              ...
              <div className="dropdown">
                ...
                <ul tabIndex="0" className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 backdrop-blur-sm rounded-box w-52">
                  ...
                  <li><Link to="/learner/playground">Playground</Link></li>
                  {/* <li><Link to="/learner/room">Room</Link></li> */}
                </ul>
              </div>
              <Link
              ...
              <div className="hidden lg:block">
                <ul className="menu menu-horizontal p-0">
                  <li><Link to="/learner/dashboard">Dashboard</Link></li>
                  <li tabIndex="0">
                    <div>
                      Modules
                      <svg className="fill-current" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                ...
                <div className="flex items-stretch">
                  <div className="dropdown dropdown-end">
                    ...
                    <ul tabIndex="0" className="menu menu-compact dropdown-content p-2 shadow bg-base-200 rounded-box w-52 mt-4">
                      <li><Link to="/learner/settings">Account Settings</Link></li>
                      <li><Link to="/learner/contact">Contact Us</Link></li>
