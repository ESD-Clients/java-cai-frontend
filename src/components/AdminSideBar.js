    ...
    <>
      <div className="drawer-side">
        ...
        <ul className="menu overflow-y-auto w-[19rem] bg-base-200 px-3">
          ...
          <li>
            <Link className="rounded-md" to="/admin/approve-modules">
              <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
          ...
          <li>
            <Link className="rounded-md" to="/admin/edit-modules">
              <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
          ...
          <li>
            <Link className="rounded-md" to="/admin/faculty-list">
          ...
          <li>
            <Link className="rounded-md" to="/admin/student-list">
