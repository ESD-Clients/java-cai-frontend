                ...
                <div className="w-full lg:pr-8 p-0">
                  ...
                  <div className="flex flex-col items-center mb-8">
                    ...
                    <ul className="menu menu-horizontal bg-base-200 rounded-box p-2">
                      <li className="tooltip tooltip-bottom" data-tip="Approve Modules">
                        <span href="/admin/approve-modules">
                  ...
                  <div className="grid lg:grid-cols-2 gap-x-14 gap-y-8 h-full">
                    ...
                    <div className="flex flex-col">
                      ...
                      <Link to="/faculty/faculty-list" className="border rounded-md h-full w-full">
                      {
                        faculties.length > 0 ? (
                          <>
                            <table className="table w-full">
                    ...
                    <div className="flex flex-col">
                      ...
                      <Link to="/faculty/approve-modules" className="border rounded-md h-full w-full">
                      {
                        modules.length > 0 ? (
                          <>
                            <table className="table w-full">
                    ...
                    <div className="flex flex-col">
                      ...
                      <Link to="/faculty/rooms" className="border rounded-md h-full w-full">
                      {
                        rooms.length > 0 ? (
                          <>
                            <table className="table w-full">
