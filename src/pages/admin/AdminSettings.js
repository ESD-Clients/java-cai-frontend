...
export default function AdminSettings() {
  ...
  async function updateUser(key, value) {
    ...
    let result = await AdminController.update(user.id, data);
  ...
  async function updateImage () {
    ...
    let url = await AdminController.uploadFile(image, 'student/profile');
  ...
  async function updatePassword (e) {
   ...
   showLoading({
    ...
    let result = await AdminController.updatePassword(user.email, current, newPassword);
