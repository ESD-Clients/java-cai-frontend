...
export default function Settings() {
  ...
  async function updateUser(key, value) {
    ...
    let result = await LearnerController.update(user.id, data);
  ...
  async function updateImage () {
    ...
    let url = await LearnerController.uploadFile(image, 'learner/profile');
  ...
  async function updatePassword (e) {
   ...
   showLoading({
    ...
    let result = await LearnerController.updatePassword(user.email, current, newPassword);
