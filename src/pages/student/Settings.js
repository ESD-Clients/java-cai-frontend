...
export default function Settings() {
  ...
  async function updateUser(key, value) {
    ...
    let result = await StudentController.update(user.id, data);
  ...
  async function updateImage () {
    ...
    let url = await StudentController.uploadFile(image, 'student/profile');
  ...
  async function updatePassword (e) {
   ...
   showLoading({
    ...
    let result = await StudentController.updatePassword(user.email, current, newPassword);
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="w-[30rem]">
              ...
              <Info
                ...
                type="date"
                editable
                onSave={async (value) => updateUser("dateOfBirth", value)}
              />
              <Info
                label="School"
                value={user.school}
